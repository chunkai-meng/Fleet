...
class WorkshopInfo(BaseModel):
    ...
    contact_person = models.CharField(db_column='ContactPerson', max_length=30, blank=True, null=True)
    contact_phone = models.CharField(db_column='ContactPhone', max_length=60, blank=True, null=True)
